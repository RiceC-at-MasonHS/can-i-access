...
<head>
    ...
    <title>School Network URL Reachability Report</title>
    <style>
        body {{
...
<body>
    <div class="header">
        <h1>📊 School Network URL Reachability Report</h1>
        <p>Network accessibility analysis for educational resources</p>
    </div>
    ...
    html += f"""
    <div class="footer">
        <p>📝 Report generated by URL Reachability Checker Script on {current_time}</p>
        <p>🏫 This report analyzes website accessibility from within your school's network</p>
    </div>
</body>
</html>"""
...
if __name__ == "__main__":
    ...
    output_filename = "url_reachability_report.html"
    try:
